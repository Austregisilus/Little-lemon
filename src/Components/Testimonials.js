...
import jane from "../Components/Assets/janeDoe.jpg";
import jonathan from "../Components/Assets/jonathanKent.jpg";
import mercy from "../Components/Assets/mercySmith.jpg";
...
const testimonialsData = [
  {
    ...
    image: jane,
    description:
      "Great food at affordable prices. The hospitality was great and the ambiance of t" +
      "he pace was wonderful. Would recommend.",
    job: "Food critic, Chicago",
  },
  {
    id: 2,
    name: "Mercy Smith",
  ...
  },
  {
    ...
    description:
      "Great food at affordable prices. The hospitality was great and the ambiance of t" +
      "he pace was wonderful. Would recommend.",
    job: "Food journalist, Chicago",
  },
];

const Testimonials = () => {
  return (
    <div className="w-full px-6 lg:px-8 py-10 bg-slate-100">
      <h5 className="lg:text-[30px] font-bold text-lime-500 text-[20px] text-center">
        Testimonials
      </h5>
      <h1 className="lg:text-[40px] text-center font-bold text-slate-900 text-[30px] lg:my-10 my-10">
        What our Customers say about us?
      </h1>
      <div className="grid lg:grid-cols-3 gap-7 mx-[20px]">
        {testimonialsData.map((item) => (
          <div className="flex flex-row ring-1 ring-gray-200 shadow-lg rounded-r-[16px]">
            <img
              src={item.image}
              alt="person"
              className="w-[30%] object-cover rounded-sm"
            />
            <div>
              <p className="my-6 mx-6 text-md leading-relaxed text-slate-950">
                "{item.description}"
              </p>
              <p className="mt-6 mb-3 mx-6 text-md text-lime-500 font-bold uppercase">
                {item.name}
              </p>
              <p className="mb-6 mx-6 text-sm text-black font-bold">
                {item.job}
              </p>
            </div>
            <svg
              aria-hidden="true"
              className="-z-2 h-20 right-0 top-0"
              viewBox="0 0 17 12"
              fill="none"
